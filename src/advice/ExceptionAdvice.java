...
import org.springframework.web.HttpRequestMethodNotSupportedException;//如果报错检查有没有servlet相关包，但注意要设置为provided，而不是complied
import org.springframework.web.bind.MissingServletRequestParameterException;
import org.springframework.web.bind.annotation.ControllerAdvice;
import org.springframework.web.bind.annotation.ExceptionHandler;
import org.springframework.web.bind.annotation.ResponseBody;
import org.springframework.web.bind.annotation.ResponseStatus;
import security.TokenException;

/**
 * 全局的异常处理切面类，用它来统一处理所有的异常行为
 * Created by Lee on 2017/5/7 0007.
 */
@ControllerAdvice//该注解可声明全局的异常处理切面类，用它来统一处理所有的异常行为（内部实现：把@ExceptionHandler注解的方法应用到所有@RequestMapping注解的方法中，即可以把该异常处理器应用到所有controller中）
